...
HOW TO INSTALL WINDOWS (USING ONENOTE 2021, 2016, 2013 or 2010)
--------------------------------------------------------------------------------
- Extract Zip File into a directory on your hard disk.
- Open the extracted directory "For OneNote Desktop".
- Double click or Open the only file in the directory with OneNote Desktop.
...
- Now Open the folder "For Online Importer", then select the notebook folder (eg: KanBan, Calendars etc ...) and click upload to import it.
